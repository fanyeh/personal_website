<template>
  <div id="calcualtor">
    ...
    <table>
      <tr>
        <td id="equation" colspan="4">{{equationString}}</td>
      </tr>
      <tr>
        <td id="screen" colspan="4">{{screen}}</td>
      </tr>
      <tr>
        <td @click="calculate(1)">1</td>
        <td @click="calculate(2)">2</td>
        <td @click="calculate(3)">3</td>
        <td class="operator" @click="calculate('+')">+</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="operator" @click="calculate('x')">x</td>
      </tr>
      <tr>
        <td class="clear" @click="calculate('C')">C</td>
...
table>tr>td:not(#screen):not(#equation) {
  width: 70px;
  height: 70px;
  font-size: 25px;
  font-weight: 100;
...
table>tr>td:active:not(#screen):not(#equation) {
